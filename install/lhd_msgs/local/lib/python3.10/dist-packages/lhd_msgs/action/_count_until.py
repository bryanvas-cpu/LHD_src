    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'lhd_msgs.action.CountUntil_Goal')
            logger.debug(
...
class Metaclass_CountUntil_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'lhd_msgs.action.CountUntil_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_CountUntil_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'lhd_msgs.action.CountUntil_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_CountUntil_SendGoal_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lhd_msgs.action import CountUntil
...
class CountUntil_SendGoal_Request(metaclass=Metaclass_CountUntil_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'lhd_msgs/CountUntil_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['lhd_msgs', 'action'], 'CountUntil_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from lhd_msgs.action._count_until import CountUntil_Goal
...
class Metaclass_CountUntil_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'lhd_msgs.action.CountUntil_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from lhd_msgs.action import _count_until
...
class CountUntil_SendGoal(metaclass=Metaclass_CountUntil_SendGoal):
    from lhd_msgs.action._count_until import CountUntil_SendGoal_Request as Request
    from lhd_msgs.action._count_until import CountUntil_SendGoal_Response as Response
...
class CountUntil_GetResult_Response(metaclass=Metaclass_CountUntil_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'lhd_msgs/CountUntil_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['lhd_msgs', 'action'], 'CountUntil_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from lhd_msgs.action._count_until import CountUntil_Result
...
class Metaclass_CountUntil_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'lhd_msgs.action.CountUntil_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_GetResult(metaclass=Metaclass_CountUntil_GetResult):
    from lhd_msgs.action._count_until import CountUntil_GetResult_Request as Request
    from lhd_msgs.action._count_until import CountUntil_GetResult_Response as Response
...
class Metaclass_CountUntil_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'lhd_msgs.action.CountUntil_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class CountUntil_FeedbackMessage(metaclass=Metaclass_CountUntil_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'lhd_msgs/CountUntil_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['lhd_msgs', 'action'], 'CountUntil_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from lhd_msgs.action._count_until import CountUntil_Feedback
...
class CountUntil(metaclass=Metaclass_CountUntil):
    ...
    from lhd_msgs.action._count_until import CountUntil_Goal as Goal
    # The result message defined in the action definition.
    from lhd_msgs.action._count_until import CountUntil_Result as Result
    # The feedback message defined in the action definition.
    from lhd_msgs.action._count_until import CountUntil_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from lhd_msgs.action._count_until import CountUntil_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from lhd_msgs.action._count_until import CountUntil_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from lhd_msgs.action._count_until import CountUntil_FeedbackMessage as FeedbackMessage
