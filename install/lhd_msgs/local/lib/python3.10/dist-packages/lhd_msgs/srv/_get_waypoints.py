...
class GetWaypoints_Request(metaclass=Metaclass_GetWaypoints_Request):
    ...
    def end(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Pose), \
                "The 'end' field must be a sub message of type 'Pose'"
        self._end = value
...
class Metaclass_GetWaypoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from lhd_msgs.srv import _get_waypoints
...
class GetWaypoints(metaclass=Metaclass_GetWaypoints):
    from lhd_msgs.srv._get_waypoints import GetWaypoints_Request as Request
    from lhd_msgs.srv._get_waypoints import GetWaypoints_Response as Response
