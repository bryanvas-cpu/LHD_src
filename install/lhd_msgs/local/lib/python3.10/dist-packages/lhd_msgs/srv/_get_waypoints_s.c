...
bool lhd_msgs__srv__get_waypoints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lhd_msgs.srv._get_waypoints.GetWaypoints_Request", full_classname_dest, 48) == 0);
  }
  lhd_msgs__srv__GetWaypoints_Request * ros_message = _ros_message;
  {  // start
  ...
  {  // end
    ...
    if (!geometry_msgs__msg__pose__convert_from_py(field, &ros_message->end)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * lhd_msgs__srv__get_waypoints__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("lhd_msgs.srv._get_waypoints");
  ...
  {  // end
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose__convert_to_py(&ros_message->end);
    if (!field) {
      return NULL;
    }
    {
...
ROSIDL_GENERATOR_C_EXPORT
bool lhd_msgs__srv__get_waypoints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lhd_msgs.srv._get_waypoints.GetWaypoints_Response", full_classname_dest, 49) == 0);
  }
  lhd_msgs__srv__GetWaypoints_Response * ros_message = _ros_message;
  {  // waypoints
